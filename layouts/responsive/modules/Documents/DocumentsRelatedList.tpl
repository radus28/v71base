                    ...
                    {foreach item=RELATED_LINK from=$RELATED_LIST_LINKS['LISTVIEWBASIC']}
						...
						{if $RELATED_LINK->get('linkmodule') eq 'Documents'}
                            <div class="col-sm-3">
                                ...
                                {/if}
                                <button type="button" module="{$RELATED_MODULE_NAME}"  class="btn addButton btn-se7en
    ...
    <script type="text/javascript">
        jQuery(function() {
            if(typeof Documents_Index_Js !== 'function') {
                jQuery("body").append('<script type="text/javascript" src="layouts/responsive/modules/Documents/resources/Documents.js"><\/script>');
            }
        });
    </script>
{/literal}
