...
{strip}
	{include file="layouts/responsive/modules/Vtiger/Header.tpl"}
...
<nav class="navbar navbar-default navbar-fixed-top app-fixed-navbar">
		<div class="container-fluid global-nav">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-2 paddingRight0 app-navigator-container">
					<div class="row">
						...
						<div class="logo-container col-lg-8 col-md-8 col-sm-8 hidden-xs">
							<div class="row">
				...
				<div class="search-links-container col-md-3 col-lg-3 col-xs-6 hidden-sm">
					<div class="search-link col-xs-4">
				...
				<div id="navbar" class="col-sm-6 col-md-3 col-lg-3 collapse navbar-collapse navbar-right global-actions">
					<ul class="nav navbar-nav">
																	...
																	<ul class="dropdown-menu quickcreateMoreDropdown" aria-labelledby="menubar_quickCreate_{$moduleModel->getName()}">
																		...
																		<li id="VtigerAction">
																			<a href="javascript:Documents_Index_Js.uploadTo('Vtiger')">
																				<img style="  margin-top: -3px;margin-right: 4%;" title="Vtiger" alt="Vtiger" src="layouts/responsive/skins//images/Vtiger.png">
						...
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($CALENDAR_MODULE_MODEL->getId())}
							<li><div><a href="index.php?module=Calendar&view={$CALENDAR_MODULE_MODEL->getDefaultViewName()}" class="vicon vicon-calendar" title="{vtranslate('Calendar','Calendar')}" aria-hidden="true"></a></div></li>
						{/if}
									...
									<div class="row">
										...
										<div class="col-lg-12 col-sm-12">
											<div class="profile-container">
												...
												<h4 style="margin-top: 30px;">{$USER_MODEL->get('first_name')} {$USER_MODEL->get('last_name')}</h4>
												<h5 class="textOverflowEllipsis" title='{$USER_MODEL->get('user_name')}'>{$USER_MODEL->get('user_name')} | {$USER_MODEL->getUserRoleName()}</h5>
											</div>
										</div>
									</div>
...
<div class="col-xs-4 visible-xs padding0px pull-right">
	<div class="dropdown btn-group pull-right">
						
								<button class="btn dropdown-toggle" style="background-color: #2C3B49;padding: 12px;color: #fff;margin-top: -1px;margin-bottom:0px;border: none;" data-toggle="dropdown" aria-expanded="true">
									<a href="#" id="menubar_quickCreate_mobile" class="qc-button" title="{vtranslate('LBL_QUICK_CREATE',$MODULE)}" aria-hidden="true"><i class="fa fa-plus-circle"></i>&nbsp;<span class="caret"></span></a>
								</button>
...
<div class="dropdown btn-group pull-right">
    <button style="background-color: #2C3B49;padding: 12px;color: #fff;margin-top: -1px;margin-bottom:0px;border: none;border-right: 1px solid #fff; " class="btn dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-gear"></i>
    &nbsp;<span class="caret"></span></button>
						...
						{assign var=CALENDAR_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Calendar')}
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($CALENDAR_MODULE_MODEL->getId())}
							<li><a href="index.php?module=Calendar&view={$CALENDAR_MODULE_MODEL->getDefaultViewName()}" title="{vtranslate('Calendar','Calendar')}" aria-hidden="true"><i class="vicon vicon-calendar"></i>&nbsp;{vtranslate('Calendar','Calendar')}</a></li>
						{/if}
						{assign var=REPORTS_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Reports')}
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($REPORTS_MODULE_MODEL->getId())}
							<li><a href="index.php?module=Reports&view=List" title="{vtranslate('Reports','Reports')}" aria-hidden="true"><i class="fa fa-bar-chart"></i>&nbsp;{vtranslate('Reports','Reports')}</a></li>
						{/if}
                        <li class="divider"></li>
                        ...
                        {$USER_MODEL->get('user_name')} | {$USER_MODEL->getUserRoleName()}
						 ...
						 <li class="divider"></li>
						<li>
						<a id="menubar_item_right_LBL_MY_PREFERENCES" href="{$USER_MODEL->getPreferenceDetailViewUrl()}"><i class="fa fa-cogs"></i>&nbsp;{vtranslate('LBL_MY_PREFERENCES')}</a>
						</li>
						<li>
						<a id="menubar_item_right_LBL_SIGN_OUT" href="index.php?module=Users&action=Logout"><i class="fa fa-power-off"></i>&nbsp;{vtranslate('LBL_SIGN_OUT')}</a>
						</li>
