...
* All Rights Reserved.
************************************************************************************}
<div class="col-xs-12 text-center visible-xs visible-sm" style="">
	<a class="btn btn-se7en-white" onclick="$('.sidebar-menu').toggleClass('hidden-xs hidden-sm')">Options 
    ...
    <div class="module-filters" id="module-filters">
        <div class="sidebar-container lists-menu-container">
            <div class="sidebar-header clearfix">
                ...
                <button id="createFilter" data-url="{CustomView_Record_Model::getCreateViewUrl($MODULE)}" class="btn btn-sm btn-se7en-white pull-right sidebar-btn" title="{vtranslate('LBL_CREATE_LIST',$MODULE)}">
