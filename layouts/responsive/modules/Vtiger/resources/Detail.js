...
Vtiger.Class("Vtiger_Detail_Js",{
    ...
    getRelatedListSearchParams : function() {
        ...
        var relatedList = detailViewContainer.find('.searchRow');
        var searchParams = [];
        var currentSearchParams = [];
        if(jQuery('#currentSearchParams').val()) {
            currentSearchParams = JSON.parse(jQuery('#currentSearchParams').val());
        }
        relatedList.find('.listSearchContributor').each(function(index,domElement){
            var searchInfo = [];
    ...
    registerAjaxEditSaveEvent : function(contentHolder){
        ...
        contentHolder.on('click','.inlineAjaxSave',function(e){
            ...
            if(fieldElement.is('input:checkbox')) {
                ...
                var ajaxEditNewValue = fieldElement.data('value');
                if(ajaxEditNewValue===undefined) var ajaxEditNewValue = fieldElement.attr('value');
                }
    ...
    toggleCommentContent: function (e) {
        ...
        var commentContentInfo = currentTarget.closest('.commentInfoContent');
	...
	var shortComment = vtUtils.linkifyStr(commentContentInfo.data('shortcomment'));
        ...
        if (currentTarget.hasClass('showMore')) {
            ...
            commentContentInfo.html(shortComment+toggleElement.clone().html());

/*		
            var maxLength = 200;//commentContentInfo.data('maxlength');
            toggleElement.find('small').text(commentContentInfo.data('more'));
            toggleElement.find('.toggleComment').addClass('showMore');
