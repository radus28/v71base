...
Vtiger_Field_Js('Vtiger_Boolean_Field_Js',{},{
	...
	isChecked : function() {
		var value = this.getValue();
		if(value==1 || value == '1' || (value && (value.toLowerCase() == 'on' || value.toLowerCase() == 'yes' || value.toLowerCase() == 'sì'))){
...
Vtiger_Field_Js('Vtiger_Date_Field_Js',{},{
	...
	getUi : function() {
		...
		var html = '<div class="referencefield-wrapper"><div class="input-group date">'+
						...
						'<span class="input-group-addon"><i class="vicon vicon-calendar"></i></span>'+
					'</div></div>';
