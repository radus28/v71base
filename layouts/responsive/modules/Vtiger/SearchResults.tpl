...
{strip}
	<script type="text/javascript" src="{vresource_url('layouts/responsive/modules/Vtiger/resources/List.js')}"></script>
	<script type="text/javascript" src="{vresource_url('layouts/responsive/modules/Vtiger/resources/SearchList.js')}"></script>
