...
<div class = "{$CLASS_VIEW_ACTION}">
    <div class="btn-group pull-right">
        <button type="button" id="PreviousPageButton" class="btn btn-se7en-white" {if !$PAGING_MODEL->isPrevPageExists()} disabled {/if}><i class="fa fa-caret-left"></i></button>
        {if $SHOWPAGEJUMP}
            <button type="button" id="PageJump" data-toggle="dropdown" class="btn btn-se7en-white">
        ...
        {/if}
        <button type="button" id="NextPageButton" class="btn btn-se7en-white" {if !$PAGING_MODEL->isNextPageExists()}disabled{/if}><i class="fa fa-caret-right"></i></button>
    </div>
