...
<div class="col-sm-12 col-xs-12 ">
    ...
    <div id="table-content" class="table-container" >
        <div  class="row row-centered" style="margin-top:10px;">
            <div class=" col-md-6 form-group col-centered searchDropDown" style="display:none;">
                <label style="margin-right: 5px;">{vtranslate('Search By',$MODULE)}</label>
                <select class="select2 inputElement searchoption" style="width:auto;min-width: 100px;">

                </select>
                <custom class="searchfield">
                    <input class="inputElement" placeholder="Enter your keyword" style="width:auto;min-width: 100px;padding-left: 5px;height: 32px;" name="test"/>    
                </custom>
                <custom>
                    <button class="btn btn-success btn-sm triggerListSearch" ><i class="fa fa-search"></i> {vtranslate("LBL_SEARCH",$MODULE)}</button>
                </custom>
            </div>
        </div>
                        ...
                        <tr class="searchRow">
                            <th class="inline-search-btn">
                                <div class="table-actions">
                                    <button class="btn btn-success btn-sm" data-trigger="listSearch"><i class="fa fa-search"></i> {vtranslate("LBL_SEARCH",$MODULE)}</button>
                                </div>
                            </th>
