		...
		<div class="widget_header clearfix">
			...
			<div class="btn-group pull-right" style="margin-top: -5px;">
				{if $CALENDAR_MODEL->isPermitted('CreateView')}
					<button class="btn addButton btn-md btn-se7en createActivity toDotask textOverflowEllipsis max-width-100" title="{vtranslate('LBL_ADD_TASK',$MODULE_NAME)}" type="button" href="javascript:void(0)" data-url="sourceModule={$RECORD->getModuleName()}&sourceRecord={$RECORD->getId()}&relationOperation=true" >
						<i class="fa fa-plus"></i>&nbsp;
						<span class="hidden-sm hidden-xs">{vtranslate('LBL_ADD_TASK',$MODULE_NAME)}</span>
					</button>&nbsp;
					<button class="btn addButton btn-md btn-se7en createActivity textOverflowEllipsis max-width-100" title="{vtranslate('LBL_ADD_EVENT',$MODULE_NAME)}" data-name="Events"
						...
						<div class='media'>
							<div class='row'>
								<div class='media-left module-icon col-lg-1 col-md-1 col-sm-1 textAlignCenter'>
									<span style="display: inline-table;" class='vicon-{strtolower($RECORD->get('activitytype'))}'></span>
								</div>
