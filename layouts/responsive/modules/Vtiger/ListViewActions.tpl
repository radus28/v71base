    ...
    <div id="listview-actions" class="listview-actions-container">
        ...
        <div class = "row">
            ...
            <div class="btn-group listViewActionsContainer" role="group" aria-label="...">
                {if $editAction}
                    <button type="button" class="btn btn-se7en-orange" id={$MODULE}_listView_massAction_{$editAction->getLabel()} 
                ...
                {/if}
                {if $deleteAction}
                    <button type="button" class="btn btn-se7en" id={$MODULE}_listView_massAction_{$deleteAction->getLabel()} 
                ...
                {/if}
                {if $commentAction}
                    <button type="button" class="btn btn-se7en-blue" id="{$MODULE}_listView_massAction_{$commentAction->getLabel()}" 
                ...
                {if count($LISTVIEW_MASSACTIONS_1) gt 0 or $LISTVIEW_LINKS['LISTVIEW']|@count gt 0}
                    <div class="btn-group listViewMassActions" role="group">
                        <button type="button" class="btn btn-se7en-white btn-sm dropdown-toggle" data-toggle="dropdown">
