					...
					<div class="btn-group">
						{if $IS_CREATE_PERMITTED}
								<button id="calendarview_basicaction_addevent" type="button" 
										class="btn addButton btn-default module-buttons app-{$SELECTED_MENU_CATEGORY} cursorPointer" 
										onclick='Calendar_Calendar_Js.showCreateEventModal();'>
									<div class="fa fa-plus" aria-hidden="true"></div>
									<span class="hidden-sm hidden-xs">&nbsp;&nbsp;{vtranslate('LBL_ADD_EVENT', $MODULE)}</span>
								</button>
								<button id="calendarview_basicaction_addtask" type="button" 
										class="btn addButton btn-default module-buttons app-{$SELECTED_MENU_CATEGORY} cursorPointer" 
										onclick='Calendar_Calendar_Js.showCreateTaskModal();'>
									<div class="fa fa-plus" aria-hidden="true"></div>
									<span class="hidden-sm hidden-xs">&nbsp;&nbsp;{vtranslate('LBL_ADD_TASK', $MODULE)}</span>
								</button>
						{/if}
									<button type="button" class="btn btn-default module-buttons app-{$SELECTED_MENU_CATEGORY} dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
