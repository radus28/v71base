...
<script type="text/javascript" src="{vresource_url('layouts/responsive/modules/Vtiger/resources/ExtensionCommon.js')}"></script>
<script type="text/javascript" src="{vresource_url('layouts/responsive/modules/Vtiger/resources/Extension.js')}"></script>
