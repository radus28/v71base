...
<script type="text/javascript" src="{vresource_url('layouts/responsive/modules/Inventory/resources/Edit.js')}"></script>
<script type="text/javascript" src="{vresource_url('layouts/responsive/modules/'|cat:{$MODULE}|cat:'/resources/Edit.js')}"></script>
