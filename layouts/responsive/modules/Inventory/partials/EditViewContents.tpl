             ...
             <div class='fieldBlockContainer'>
                 ...
                 <div class="table table-borderless {if $BLOCK_LABEL eq 'LBL_ADDRESS_INFORMATION'} addressBlock{/if}">
                     {if ($BLOCK_LABEL eq 'LBL_ADDRESS_INFORMATION') and ($MODULE neq 'PurchaseOrder')}
                        <div class="row">
                            <div class="col-md-3 col-sm-12 col-xs-12 fieldLabel " name="copyHeader1">
                                <label  name="togglingHeader">{vtranslate('LBL_BILLING_ADDRESS_FROM', $MODULE)}</label>
                            </div>
                            <div class="col-md-3 col-sm-12 col-xs-12 fieldValue" name="copyAddress1">
                                <div class="radio">
                                    <label>
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12 fieldLabel" name="copyHeader2">
                                <label  name="togglingHeader">{vtranslate('LBL_SHIPPING_ADDRESS_FROM', $MODULE)}</label>
                            </div>
                            <div class="col-md-3 col-sm-12 col-xs-12 fieldValue" name="copyAddress2">
                                <div class="radio">
                                    <label>
                    ...
                    {/if}
                     ...
                     {foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
                         ...
                         {if $FIELD_MODEL->isEditable() eq true}
                             ...
                             {/if}
                             <div class="col-md-3 col-sm-12 col-xs-12  fieldLabel alignMiddle">
                         ...
                         <div class="col-md-3 col-sm-12 col-xs-12  fieldValue" {if $FIELD_MODEL->getFieldDataType() eq 'boolean'} style="width:25%" {/if} {if $FIELD_MODEL->get('uitype') eq '19'} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}>
