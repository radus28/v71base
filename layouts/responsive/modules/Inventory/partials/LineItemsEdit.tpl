...
<div name='editContent'>
	...
	{if $BLOCK_FIELDS|@count gt 0}
				...
				{if $PRODUCT_ACTIVE eq 'true' && $SERVICE_ACTIVE eq 'true'}
					<div class="btn-toolbar">
						<span class="btn-group">
							<button type="button" class="btn btn-se7en" id="addProduct" data-module-name="Products" >
								<i class="fa fa-plus"></i>&nbsp;&nbsp;<strong>{vtranslate('LBL_ADD_PRODUCT',$MODULE)}</strong>
							</button>
						</span>
						<span class="btn-group">
							<button type="button" class="btn btn-se7en" id="addService" data-module-name="Services" >
		...
		<br>
		<table class="table table-bordered table-striped blockContainer lineItemTable" id="lineItemResult">
			<tr>
				<td width="83%">
